        ...
        <div className="flex flex-col items-center text-center">
          <div className="space-y-6 max-w-3xl mx-auto animate-fade-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              <Link to="/plans" className="primary-button flex items-center gap-2 rounded-full">
                Descobrir máquinas
                <ArrowRight className="h-5 w-5" />
              </Link>
              
              <Link to="/about" className="subtle-button rounded-full">
                Saiba mais
              </Link>
            </div>
          ...
          <div className="mt-12 animate-fade-up animation-delay-500 max-w-3xl mx-auto">
